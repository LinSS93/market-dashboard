 ...
 */
export const RADAR_PRODUCTION_DEFAULTS = Object.freeze({
  SIGNAL_ALGO_VERSION: 'v2',
});

export function applyRadarProductionDefaults(env = process.env) {
  for (const [key, value] of Object.entries(RADAR_PRODUCTION_DEFAULTS)) {
