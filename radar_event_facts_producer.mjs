...
//   8. 使用 getRadarDb()（而非 getRadarDb()）访问数据库，使测试可通过
//      setRadarDbForTest 注入临时 DB。news_articles 和 radar_v2_event_facts 表
//      均由 radar_schema.mjs execSchema 创建（V2 自包含）。
...
// 与 radar_dossier_producer.mjs fetchOfficialEvents 相同的双窗口策略：
