...
import { DEFAULT_WEIGHTS, invalidateActiveWeightsCache, isValidBaseScoreWeights, normalizeBaseScoreWeights } from './radar_scoring.mjs';
...
/**
 * 查询反馈调权状态（供 HTTP 端点 /radar/feedback/status）。
 *
