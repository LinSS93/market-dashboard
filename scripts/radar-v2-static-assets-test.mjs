...
const radarScriptPath = resolve(root, 'app', 'radar-v2.js');
const serverPath = resolve(root, 'server.mjs');
const radarScript = readFileSync(radarScriptPath, 'utf8');
const serverSource = readFileSync(serverPath, 'utf8');
const servedRadarModulePattern = /^\/radar-v2-[a-z0-9-]+\.mjs$/i;
...
check(
  serverSource.includes("/^\\/radar-v2-[a-z0-9-]+\\.mjs$/i.test(p)"),
