...
//
// 模拟 loadAndRender 的核心逻辑（与 app/radar-v2.js 中 loadAndRender 守卫同构）：
//   const reqId = guard.next();
//   const data = await fetch();
//   if (!guard.isLatest(reqId)) return;  // 丢弃
//   applied = data;
//
// 运行：node scripts/radar-v2-loadguard-test.mjs

import { createRequestGuard } from '../app/radar-v2-loadguard.mjs';
