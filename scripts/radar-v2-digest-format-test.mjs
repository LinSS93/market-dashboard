...
import { buildRadarV2DigestMessage } from '../alert_engine.mjs';
...
const message = buildRadarV2DigestMessage('HK', { risks, crossConfirm, newSignals }, ['risk', 'confirmed', 'new']);
console.log(message);
...
const onlyNew = buildRadarV2DigestMessage('US', { risks, crossConfirm, newSignals }, ['new']);
