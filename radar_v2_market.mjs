...
export const RADAR_V2_ADAPTERS = Object.freeze({
  US: Object.freeze({
    market: 'US',
...
export function adapterFor(market) {
  return RADAR_V2_ADAPTERS[String(market || '').toUpperCase()] || null;
}

export function getAllAdapters() {
  return Object.values(RADAR_V2_ADAPTERS);
}
...
export async function loadDailyBars(adapter, symbol, options = {}) {
  ...
  //   - 手动 /radar_v2/refresh 若需强制刷新，应通过 skipCache: true 显式指定
