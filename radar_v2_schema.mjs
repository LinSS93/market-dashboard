...
//   - 测试可通过 setRadarV2DbForTest 注入临时 DB
 ...
 */
export function setRadarV2DbForTest(db) {
  _testDb = db;
 ...
 */
export function clearRadarV2DbForTest() {
  _testDb = null;
  for (const reset of _stmtReseters) reset();
}
...
export function lazyStmt(sql) {
  ...
  return new Proxy({}, {
    get(_target, prop) {
      if (!cached) cached = getRadarV2Db().prepare(sql);
