...
//
// V2 独立评分引擎，只依赖：
//   - radar_schema.mjs  getRadarDb（查询 radar_v2_event_facts）
//   - radar_financial_store.mjs  getV2FinancialHistory（查询财务数据）
//   - radar_financial_timing.mjs  isFinancialTimingUsable
//
...
//   - 技术指标统一调用 radar_indicators.mjs（纯函数，与趋势状态机共享）
//   - 评分边界全部 clamp 到 [0, 100]

import { getRadarDb, getActiveScoringProfile } from './radar_schema.mjs';
import { clamp, safeNumber, sma, rsi, avgVolume, volumeRatio, maSlope } from './radar_indicators.mjs';
